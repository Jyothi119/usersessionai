...
matcor = (num / den)
print('The correlation coefficient for the random forest model is: {:.2f}'.format(matcor))
...
matcor1 = (num1 / den1)
print('The correlation coefficient for the logistic regression model is the model is: {:.2f}'.format(matcor1))
gnb=GaussianNB()
